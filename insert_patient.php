<?php
    ...
    VALUES ('$_POST[icnum]', '$_POST[Fname]','$_POST[gender]','$_POST[res_address]','$_POST[country]','$_POST[state]','$_POST[city]','$_POST[postcode]'
    ,'$_POST[contactnum]');";

    $patienthealthstatus = "INSERT INTO health_status (ic, patient_name, weight, height, bmi, blood_pressure, blood_sugar, cholesterol_level,
    heart_rate, activities_of_daily_life, falling, incontinence, cognitive)
